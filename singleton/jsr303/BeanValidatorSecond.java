 ...
 * @since 8.0
 */
public class BeanValidatorSecond implements Validator<Object> {
            ...
            try {
                ...
                Logger.getLogger(BeanValidator.class.getName())
                        .fine("A JSR-303 bean validation implementation not found on the classpath. "
                                + BeanValidator.class.getSimpleName() + " cannot be used.");
     ...
     *             if {@link #checkBeanValidationAvailable()} returns false
     */
    public BeanValidator(Class<?> beanType, String propertyName, Locale locale) {
